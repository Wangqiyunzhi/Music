  ...
  routes: [
...

    {
      ...
      children:[
        ...
        {
          path: '/AdminInfo',
          component: resolve => require(['../pages/AdminInfoPage.vue'], resolve)
        },
        {
          path: '/Consumer',
        ...
        {
          path: '/Banner',
          component: resolve => require(['../pages/BannerPage.vue'], resolve)
        },
        {
          path: '/Notice',
        ...
        {
          path: '/Stats',
          component: resolve => require(['../pages/StatsPage.vue'], resolve)
        }
